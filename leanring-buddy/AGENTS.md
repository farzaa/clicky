...
- `CodexAPI.swift`, `ClaudeAPI.swift`, `ElevenLabsTTSClient.swift`, and `AssemblyAIStreamingTranscriptionProvider.swift` talk to the Worker proxy for runtime AI, TTS, and AssemblyAI tokens.
