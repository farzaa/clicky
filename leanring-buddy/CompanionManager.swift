...
final class CompanionManager: ObservableObject {
    ...
    /// buddy should fly to and point at. Parsed from the Codex response;
    ...
    /// The Codex response may include a [POINT:x,y:label] tag which triggers
    ...
    private func sendTranscriptToCodexWithScreenshot(transcript: String) {
        ...
        currentResponseTask = Task {
            ...
            do {
                ...
                // Parse the [POINT:...] tag from the Codex response
                ...
                if let pointCoordinate = parseResult.coordinate,
                   let targetScreenCapture {
                    // Codex coordinates are in the screenshot's pixel space
    ...
    /// Result of parsing a [POINT:...] tag from the Codex response.
    ...
    /// Parses a [POINT:x,y:label:screenN] or [POINT:none] tag from the end of the Codex response.
    ...
    /// Captures a screenshot and asks Codex to find something interesting to
    ...
    func performOnboardingDemoInteraction() {
        ...
        Task {
            do {
                ...
                // Only send the cursor screen so Codex can't pick something
                ...
                // Set custom bubble text so the pointing animation uses Codex's
