...
function loadSettings() {
  ...
  const hotkeyBtn = document.getElementById("hotkey-display");
  ...
  if (hotkeyBtn) {
    hotkeyBtn.textContent = getSetting("hotkey").replace(/\+/g, " + ");
  }
...
function startHotkeyRecording() {
  const btn = document.getElementById("hotkey-display");
  if (!btn || hotkeyRecording) return;
  ...
  function onKeydown(e) {
    ...
    setSetting("hotkey", combo);
    btn.textContent = combo.replace(/\+/g, " + ");
