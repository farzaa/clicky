...
- **Settings** — configurable hotkey, audio devices, screenshot quality, overlay appearance, autostart
- **OIDC auth** — Authentik login → OpenBao token, stored in system keyring, auto-refresh
...
| Push-to-talk hotkey | localStorage | `Ctrl + Space` |
